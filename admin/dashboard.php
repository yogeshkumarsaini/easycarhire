...
<head>
	...
	<title>Easy Car Hire | Admin Dashboard</title>
...
<?php include('includes/leftbar.php');?>
		<div class="content-wrapper" style="background-image:url(img/grant.jpg); background-size:cover; background-repeat:no-repeat;height:42.55em;background-position:center;">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="border-bottom:5px solid grey;">Dashboard</h2>		
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-ghost text-gray"style="background-color:#feccbdc7;">
