...
<head>
	...
	<title>Easy Car Hire | New Bookings   </title>
...
DATEDIFF(tblbooking.ToDate,tblbooking.FromDate) as totalnodays,tblvehicles.PricePerKm
...
<tr>
	...
	<th>Rent Per Days</th>
	<td><?php echo htmlentities($ppdays=$result->PricePerKm);?></td>
</tr>
<tr>
