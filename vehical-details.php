...
$query1->bindParam(':fromaddress',$fromaddress,PDO::PARAM_STR);
$query1->bindParam(':toaddress',$toaddress,PDO::PARAM_STR);
...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,FromAddress,ToAddress,message,Status) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:fromaddress,:toaddress,:message,:status)";
...
$query->bindParam(':toaddress',$toaddress,PDO::PARAM_STR);
...
<title>Easy Car Hire | Vehicle Details</title>
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
       <!-- <div class="price_info">
          <p>₹<?php echo htmlentities($result->PricePerKm);?> </p>Per Day
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              ...
              <input type="address" class="form-control" name="fromaddress" placeholder="From Address" required>
            </div>
            <div class="form-group">
              <label>To Address:</label>
              <input type="address" class="form-control" name="toaddress" placeholder="To Address" required>
            </div>
